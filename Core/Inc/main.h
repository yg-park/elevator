...
#define PHOTO4_GPIO_Port GPIOG
#define PHOTO4_EXTI_IRQn EXTI1_IRQn
...
#define FND8_Pin GPIO_PIN_10
#define FND8_GPIO_Port GPIOB
...
#define FND2_Pin GPIO_PIN_4
#define FND2_GPIO_Port GPIOB
#define FND1_Pin GPIO_PIN_5
#define FND1_GPIO_Port GPIOB
#define FND7_Pin GPIO_PIN_6
